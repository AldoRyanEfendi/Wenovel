...
<!-- InstanceBeginEditable name="head" -->
    ...
    <?php
    	if(isset($_POST['judul'])){
			if($_POST['judul']!= NULL and $_POST['isi'] != '<p><br data-cke-filler="true"></p>'){
				require_once 'koneksi.php';
				$sql = "insert into pemberitahuan values ('', '".$_POST['judul']."', '".$_POST['isi']."','".date('Y/m/d')."');";
...
<!-- InstanceBeginEditable name="Content" -->
    ...
    <div class="form-group">
    	<label for="noch">Judul Pemberitahuan : </label>
    	<input type="text" class="form-control" id="judul" placeholder="" name="judul" value="">
  	</div>
    <div class="form-group">
    	<label for="isi">Pengumuman : </label>
    	<div id="editor">Isi Pengumuman</div>
  	</div>
    <div class="form-group">
    	<input type="submit" id="save" class="btn btn-primary" value="Simpan"/>
    </div>
    <textarea id="isi" style="visibility:hidden;" name="isi"></textarea>
    </form>
    <script>
    	InlineEditor
